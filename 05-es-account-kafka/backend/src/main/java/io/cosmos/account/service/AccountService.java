...
public class AccountService {
    ...
    public List<Event> queryEvents(QueryEvents query) {
        //
        return this.aggregateEventStore.retrieveEvents(query.getAccountNo());
    }
    ...
    public void completeDeposit(CompleteDeposit command) {
        //
        Account account = this.aggregateStore.load(command.getAccountNo());
        account.completeDeposit(command);
        this.aggregateStore.save(account);
    }
    ...
    public void completeWithdraw(CompleteWithdraw command) {
        //
        Account account = this.aggregateStore.load(command.getAccountNo());
        account.completeWithdraw(command);
        this.aggregateStore.save(account);
    }
