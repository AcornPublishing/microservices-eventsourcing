...
public abstract class Event {
    ...
    public  <T> T toEvent(Class<T> clazz) {
        //
        return JsonUtil.fromJson(this.payload(), clazz);
    }

    public IntermediateEvent toIntermediateEvent() {
        //
        return new IntermediateEvent(this.eventId, this.typeName(), JsonUtil.toJsonNode(this.payload()), this.revision);
    }
}
