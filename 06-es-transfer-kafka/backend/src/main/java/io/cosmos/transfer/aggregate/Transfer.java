...
public class Transfer extends EventSourcedAggregate {
    ...
    public void completeTransfer() {
        //
        TransferCompleted event = new TransferCompleted(this.transferId);
        event.correlationId(this.transferId);
    ...
    public void cancelTransfer() {
        //
        TransferCanceled event = new TransferCanceled(this.transferId);
        event.correlationId(this.transferId);
        this.apply(event);
    }
